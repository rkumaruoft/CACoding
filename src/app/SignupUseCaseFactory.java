...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
        ...
        try {
            ...
            ClearController clearController = clearUsersCase((ClearUserDataAccessInterface) userDataAccessObject);
    ...
    private static ClearController clearUsersCase(ClearUserDataAccessInterface clearUserDataAccessObject){
        ClearOutputBoundary clearOutputBoundary = new ClearPresenter();
        ClearInputBoundary clearUseCaseInteractor= new ClearInteractor(clearUserDataAccessObject, clearOutputBoundary);
